...
<html lang="en">
   <head>
      ...
      <title> Login - Data2Income - Earn juicy income with your Data  </title>
      <!-- Favicon -->
         ...
         <div class="row no-gutters">
            <div class="col-lg-6 align-items-stretch position-relative white-bg">
               ...
               <div class="login-info">
                  ...
                  <h6>Welcome to <span class="main-color"> Data2Income </span> please login your account.</h6>
                  @if ($errors->any())
                    <center>
                  ...
                  <form method="POST" action="{{route('login')}}">
                     ...
                     <button class="slide-button button mr-3">
                       ...
                       <a class="slide-button button bt-border" href="{{route('register')}}" style="top: 22px;">
            ...
            <div class="col-lg-6 align-self-center position-relative">
               <div class="login-right-bar h-100 text-center">
                <center>  <img src="{{asset('images/login/login.png')}}" class="img-fluid" alt="">
                </center> 
                </div>
            </div>
         </div>
...
<!-- Mirrored from iqonic.design/themes/markethon/layout-1/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Apr 2021 10:11:49 GMT -->
</html>